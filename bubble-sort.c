...
void bubbleSort (int enter_vctr[], int n)
{
    ...
    for (int i = 0; i < n - 1; i++)
    {
        ...
        {
            if (enter_vctr[j] > enter_vctr[j + 1])
            {
                changePosition(&enter_vctr[j], &enter_vctr[j + 1]);
            }
        }
    }
}

int print (int enter_vctr[], int n)
{
    for (int i = 0; i < n - 1; i++)
    {
        printf("%d\n",enter_vctr[i]);
