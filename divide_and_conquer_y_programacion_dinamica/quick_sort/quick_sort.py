class QuickSort:
    ...
    def _swap(self, n1, n2):
        tmp = self.sequence[n1]
        self.sequence[n1] = self.sequence[n2]
        self.sequence[n2] = tmp

    def partition(self, low, high):
        pivot = self.sequence[high]
        i = low - 1
        for j in range(low, high):
            if self.sequence[j] < pivot:
                i = i + 1
                self._swap(i, j)
        self._swap(i + 1, high)
        return i + 1
