class InsertionSort {
    ...
    sort () {
        for (let i = 0; i < this.length; i++) {
            const currentVal = this.sequence[i]
            let j = i - 1
            while (j >= 0 && this.sequence[j] > currentVal) {
                this.sequence[j + 1] = this.sequence[j]
                j--
            }
            this.sequence[j + 1] = currentVal
        }
    }
...
const insertionSort = new InsertionSort(sequence)
insertionSort.sort()
insertionSort.print()